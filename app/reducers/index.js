...
import {AppWithNavigationState} from '../utils/Router'

// const firstAction = AppWithNavigationState.router.getActionForPathAndParams('Main');
// const tempNavState = AppWithNavigationState.router.getStateForAction(firstAction);
// const secondAction = AppWithNavigationState.router.getActionForPathAndParams('Login');
// const initialNavState = AppWithNavigationState.router.getStateForAction(secondAction, tempNavState);
//
// function nav(state = initialNavState, action) {
//     let nextState;
//     switch (action.type) {
//         case 'Login':
//             nextState = AppWithNavigationState.router.getStateForAction(NavigationActions.back(), state);
//             break;
//         case 'Logout':
//             nextState = AppWithNavigationState.router.getStateForAction(NavigationActions.navigate({ routeName: 'Login' }), state);
//             break;
//         default:
